...
public class BachelorShow implements ShowAPI {
    private Ergenka[] ergenkas;
    private final EliminationRule[] defaultEliminationRules;

    public BachelorShow(Ergenka[] ergenkas, EliminationRule[] defaultEliminationRules) {
        this.ergenkas = ergenkas != null ? ergenkas : new Ergenka[0];
        this.defaultEliminationRules = defaultEliminationRules != null ? defaultEliminationRules : new EliminationRule[0];
    }
...
//        bachelorShow.eliminateErgenkas(eliminationRules);

        {
            ...
            BachelorShow show = new BachelorShow(ergs, defaults);
            ...
            System.out.println("Case 1 (empty rules): " + Arrays.toString(Arrays.stream(show.getErgenkas()).map(Ergenka::getName).toArray()));
        }
        System.out.println("==============================");
        {
            Ergenka[] ergs = {
            ...
            BachelorShow show = new BachelorShow(ergs, new EliminationRule[]{new LowestRatingEliminationRule()});
        ...
        System.out.println("==============================");
        {
            ...
            BachelorShow show = new BachelorShow(ergs, null);
        ...
        System.out.println("==============================");
        {
            ...
            System.out.println("Case 4: " + Arrays.toString(Arrays.stream(show.getErgenkas()).map(Ergenka::getName).toArray()));
        }
        System.out.println("==============================");
        {
            Ergenka[] ergs = {
        ...
        System.out.println("==============================");
        {
            ...
            System.out.println("Case 6 ratings: " + Arrays.toString(Arrays.stream(show.getErgenkas()).map(Ergenka::getRating).toArray()));

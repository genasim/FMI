...
public class Cache {
    ...
    public void cacheValue(Object key, Object value) {
        verifyObject(key, "Cannot cache null key");
        verifyObject(value, "Cannot cache null value");
    ...
    public Object getCachedValue(Object key) {
        verifyObject(key, "Cannot get cached value for null key");
    ...
    public boolean containsKey(Object key) {
        verifyObject(key, "Cannot search cache for null key");
    ...
    private void verifyObject(Object o, String message) {
        if (o == null) {

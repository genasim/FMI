...
import bg.exception.bg.sofia.uni.fmi.mjt.burnout.DisappointmentException;
import bg.sofia.uni.fmi.mjt.burnout.exception.InvalidSubjectRequirementsException;
import plan.bg.sofia.uni.fmi.mjt.burnout.SemesterPlan;
import bg.subject.bg.sofia.uni.fmi.mjt.burnout.UniversitySubject;
...
import bg.sofia.uni.fmi.mjt.burnout.exception.InvalidSubjectRequirementsException;
import plan.bg.sofia.uni.fmi.mjt.burnout.SemesterPlan;
import bg.semester.bg.sofia.uni.fmi.mjt.burnout.SoftwareEngineeringSemesterPlanner;
import bg.subject.bg.sofia.uni.fmi.mjt.burnout.Category;
import subject.bg.sofia.uni.fmi.mjt.burnout.SubjectRequirement;
import bg.subject.bg.sofia.uni.fmi.mjt.burnout.UniversitySubject;
